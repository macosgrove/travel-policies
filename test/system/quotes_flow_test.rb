...
class QuotesFlowTest < ApplicationSystemTestCase
  ...
  test 'Correct an error and retry' do
    ...
    assert_date Date.parse('01/01/1948'), from: 'quote_date_of_birth'

    select_date Date.parse('01/01/1958'), from: 'quote_date_of_birth'
    click_on 'Get Quote'
    assert_selector 'h1', text: "Here's your quote"
    assert_text 'A trip of 7 days for a traveller aged 60 will cost $70.00 AUD'
  end
